...
public abstract class AppCompatDelegate {
     ...
     */
    public static final int MODE_NIGHT_AMIFY = 3;
    ...
    /** @hide */
    @RestrictTo(GROUP_ID)
    @IntDef({MODE_NIGHT_NO, MODE_NIGHT_YES, MODE_NIGHT_AMIFY, MODE_NIGHT_AUTO, MODE_NIGHT_FOLLOW_SYSTEM,
            MODE_NIGHT_UNSPECIFIED})
    @Retention(RetentionPolicy.SOURCE)
    public @interface NightMode {}

    @IntDef({MODE_NIGHT_NO, MODE_NIGHT_YES, MODE_NIGHT_AMIFY, MODE_NIGHT_FOLLOW_SYSTEM})
    @Retention(RetentionPolicy.SOURCE)
